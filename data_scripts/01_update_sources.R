...
places_county_fn <- "PLACES__County_Data__GIS_Friendly_Format___2023_release.csv"

# File name of data downloaded from CDC's PLACES - Census Tract Data (GIS Friendly Format)
places_censustract_fn <- "PLACES__Census_Tract_Data__GIS_Friendly_Format___2023_release.csv"
...
schools_fn <- "EDGE_GEOCODE_PUBLICSCH_2122.xlsx"