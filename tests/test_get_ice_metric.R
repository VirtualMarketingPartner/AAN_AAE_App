...
test_that("get_ice_metric returns dataframe dat with correct fields", {
  # state
  expect_is(
    get_ice_metric(data = test_state_df,
                   level = "state"),
    "data.frame"
  )
  expect_identical(
    sort(colnames(get_ice_metric(data = test_state_df,
                                 level = "state"))),
    expected_colnames
  )
  ...
  # county
  expect_is(
    get_ice_metric(data = test_county_df,
                   level = "county",
                   st = "RI"),
    "data.frame"
  )
  expect_identical(
    sort(colnames(get_ice_metric(data = test_county_df,
                                 level = "county",
                                 st = "RI"))),
    expected_colnames
  )
  ...
  # tract
  expect_is(
    get_ice_metric(data = test_tract_df,
                   level = "tract",
                   st = "RI",
                   county = "Providence County"),
    "data.frame"
  ...
  expect_identical(
    sort(colnames(get_ice_metric(data = test_tract_df,
                                 level = "tract",
                                 st = "RI",
                                 county = "Providence County"))),
    expected_colnames
  ...
  # place
  expect_is(
    get_ice_metric(data = test_place_df,
                   level = "place",
                   st = "RI"),
    "data.frame"
  )
  expect_identical(
    sort(colnames(get_ice_metric(data = test_place_df,
                                 level = "place",
                                 st = "RI"))),
    expected_colnames
  )
...
test_that("get_ice_metric errors when given improper level", {
  expect_error(
    get_ice_metric(data = test_state_df,
                   level = "test")
  )
