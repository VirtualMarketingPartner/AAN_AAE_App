...
expected_colnames_tract <- sort(c(expected_colnames, "holc_grade_pop"))
...
test_that("get_merged_shp returns list with SpatialPolygonsDataFrame shp and data.frame dat", {
  # state
  expect_is(
    get_merged_shp(geo_level = "state",
                 acs_year = 2020),
    "list"
  )
  expect_length(
  ...
  expect_identical(
    names(get_merged_shp(geo_level = "state",
                       acs_year = 2020)),
    c("shp", "dat")
  )
  expect_is(
  ...
  expect_identical(
    sort(colnames(get_merged_shp(geo_level = "state",
                               acs_year = 2020)$dat)),
    expected_colnames
  )
  ...
  expect_identical(
    names(get_merged_shp(geo_level = "county",
                       acs_year = 2020,
                       st = "RI")),
    c("shp", "dat")
  )
  ...
  expect_identical(
    sort(colnames(get_merged_shp(geo_level = "county",
                               acs_year = 2020,
                               st = "RI")$dat)),
    expected_colnames
  )
  ...
  # tract
  expect_is(
    get_merged_shp(geo_level = "tract",
                 acs_year = 2020,
                 st = "RI",
  ...
  expect_identical(
    names(get_merged_shp(geo_level = "tract",
                       acs_year = 2020,
                       st = "RI",
                       county = "Providence County")),
    c("shp", "dat")
  ...
  expect_identical(
    sort(colnames(get_merged_shp(geo_level = "tract",
                               acs_year = 2020,
                               st = "RI",
                               county = "Providence County")$dat)),
    expected_colnames_tract
  )
  
  # place
  expect_is(
    get_merged_shp(geo_level = "place",
                 acs_year = 2020,
                 st = "RI",
                 place = "Cranston",
                 stateFP = "44",
  ...
  expect_identical(
    names(get_merged_shp(geo_level = "place",
                       acs_year = 2020,
                       st = "RI",
                       place = "Cranston",
                       stateFP = "44",
  ...
  expect_identical(
    sort(colnames(get_merged_shp(geo_level = "place",
                               acs_year = 2020,
                               st = "RI",
                               place = "Cranston",
                               stateFP = "44",
...
test_that("get_merged_shp errors when given improper level", {
  expect_error(
    get_merged_shp(geo_level = "test",
                 acs_year = 2020)
  )
})

test_that("get_merged_shp errors when given improper year", {
  expect_error(
    get_merged_shp(geo_level = "state",
                 acs_year = 0)
  )
...
test_that("get_merged_shp errors when no places_tracts file supplied", {
  expect_error(
    get_merged_shp(geo_level = "place",
                 acs_year = 2020,
                 st = "RI",
...
test_that("get_merged_shp errors when improper stateFP supplied", {
  expect_error(
    get_merged_shp(geo_level = "place",
                 acs_year = 2020,
                 st = "RI",
