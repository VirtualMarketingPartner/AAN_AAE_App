...
test_that("get_nephtn_data returns dataframe dat with correct fields", {
  # state
  expect_is(
    get_nephtn_data(data = test_state_df,
                    level = "state"),
    "data.frame"
  )
  expect_identical(
    sort(colnames(get_nephtn_data(data = test_state_df,
                                  level = "state"))),
    expected_colnames
  )
  ...
  # county
  expect_is(
    get_nephtn_data(data = test_county_df,
                    level = "county"),
    "data.frame"
  )
  expect_identical(
    sort(colnames(get_nephtn_data(data = test_county_df,
                                  level = "county"))),
    expected_colnames
  )
  ...
  # tract
  expect_is(
    get_nephtn_data(data = test_tract_df,
                    level = "tract"),
    "data.frame"
  )
  expect_identical(
    sort(colnames(get_nephtn_data(data = test_tract_df,
                                  level = "tract"))),
    expected_colnames
  )
  ...
  # place
  expect_is(
    get_nephtn_data(data = test_place_df,
                    level = "place"),
    "data.frame"
  )
  expect_identical(
    sort(colnames(get_nephtn_data(data = test_place_df,
                                  level = "place"))),
    expected_colnames
  )
})

test_that("get_nephtn_data errors when given improper level", {
  expect_error(
    get_nephtn_data(data = test_state_df,
                    level = "test")
  )
